...
### Changed
- Updated preview rendering to use markdown output
- Improved consistency across core TUI components

### Fixed
- Preview display issues in file preview and success screens
- Summarizer preview behavior and related test coverage
